   ...
   public boolean onOptionsItemSelected(MenuItem item) 
   {
      switch (item.getItemId()) 
      {
         ...
         case R.id.changeLanguage:
            LanguageDialogFragment languatedialog =
                    new LanguageDialogFragment();
            languatedialog.show(getFragmentManager(), "language dialog");
            return true;
         case R.id.eraser:
         ...
         case R.id.print:     
		  ...
		  case R.id.changeBackground:
			  BackgroundDialog back = new BackgroundDialog();
			  back.show(getFragmentManager(), "Change Background");
			  break;
      }
